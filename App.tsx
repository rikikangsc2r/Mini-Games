...
const TicTacToeIcon = () => (
  <svg viewBox="0 0 100 100" style={{ width: '100%', height: 'auto', padding: '1rem', maxHeight: '150px' }}>
    <path d="M33,5 V95 M67,5 V95 M5,33 H95 M5,67 H95" stroke="#495057" strokeWidth="6" />
    <path d="M10,10 L30,30 M10,30 L30,10" stroke="#0dcaf0" strokeWidth="8" strokeLinecap="round" />
    <circle cx="50" cy="50" r="10" stroke="#ffc107" strokeWidth="8" fill="none" />
  </svg>
);
...
const App: React.FC = () => {
  ...
  const renderGame = () => {
    switch (currentGame) {
      case 'tictactoe':
        return <TicTacToe onBack={backToMenu} />;
      case 'gobblet':
